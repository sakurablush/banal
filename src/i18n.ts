...
import { applyTranslationContent } from './lib/safe-html';
...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    'promptTemplates.howTo.step1':
      'Pick a chat from the chips below — Duck.ai, Copilot, or Meta AI need no account.',
    'promptTemplates.howTo.step2': 'Pick a card. Filter by category on the left, or just scroll.',
    'promptTemplates.howTo.step3':
      'Fill what feels true. Leave the rest — the AI will help you finish it.',
    'promptTemplates.howTo.step4': 'Click "Copy Filled" and paste the whole block into your chat.',
    'promptTemplates.howTo.step5':
      'Talk back. "Shorter", "Add a JA version with keigo", "Verify every number". Most of the value is in the follow-up.',
    ...
    'limitations.5.desc': 'Access type and caveats are on the card. Check them before you click.',
    'limitations.reportOutdated': 'Found outdated information?',
    'limitations.reportLink': 'Report it on GitHub →',
    'limitations.linkSeparator': ' · ',
    'limitations.discussLink': 'Discuss on GitHub →',
    ...
    'section.support.eyebrow': 'KEEP BUILDING',
    'section.support.title1': 'Optional support.',
    'section.support.title2': 'Same honesty as the catalog.',
    'section.support.desc':
      'Banal is free to use — no paywall, no accounts, no ads. Building and maintaining it takes real time and model tokens, from one self-funded stack.',
    'section.support.contributeTitle': 'Contribute in code',
    'section.support.contributeDesc':
      'Public repo on a personal account — no collaborator invite needed. Report broken links or ideas in <a href="https://github.com/sakurablush/banal/issues" target="_blank" rel="noopener noreferrer" class="text-violet-400 hover:text-violet-300 underline">Issues</a> or <a href="https://github.com/sakurablush/banal/discussions" target="_blank" rel="noopener noreferrer" class="text-violet-400 hover:text-violet-300 underline">Discussions</a>. To change code, fork and open a pull request — I review and merge when it fits.',
    'section.support.tipTitle': 'Chip in financially',
    'section.support.tipDesc':
      'Only if Banal saved you time or money and you want to help cover the next round of research and inference — creation or upkeep. No tiers, no perks, no obligation.',
    'section.support.bitcoin': 'Bitcoin',
    'section.support.ethereum': 'Ethereum',
    'section.support.litecoin': 'Litecoin',
    'section.support.dogecoin': 'Dogecoin',
    'section.support.copy': 'Copy',
    'section.support.copied': 'Copied',
    ...
    'article.agents2026.meta.title': 'The Honest Truth About AI Coding Agents in 2026 | Banal',
    ...
    'article.agents2026.card.title': 'The Honest Truth About AI Coding Agents in 2026',
  ...
  ja: {
    ...
    'promptTemplates.panel.philosophy': '出発点です。正式な送付前に出力を確認してください。',
    ...
    'promptTemplates.howTo.step1':
      '下のチップからチャットを選ぶ — Duck.ai、Copilot、Meta AI はアカウント不要。',
    'promptTemplates.howTo.step2': 'カードを選ぶ。左のカテゴリで絞り込むか、横にスクロール。',
    'promptTemplates.howTo.step3':
      '本当だと思うところだけ埋める。残りはAIが一緒に仕上げてくれます。',
    'promptTemplates.howTo.step4':
      '「コピーして入力」をクリックし、ブロック全体をチャットに貼り付ける。',
    'promptTemplates.howTo.step5':
      '「もっと短く」「敬語付きの日本語版も」「数字を確認して」等と返す。価値はフォローアップにある。',
    'promptTemplates.howTo.privacy':
    ...
    'limitations.1.desc': '幻覚、拒否、古い情報があり得る。重要な内容は自分で確認する。',
    ...
    'limitations.5.desc': 'アクセス種別と注意点はカードに記載。クリック前に確認。',
    'limitations.reportOutdated': '情報が古いですか？',
    'limitations.reportLink': 'GitHubで報告 →',
    'limitations.linkSeparator': ' · ',
    'limitations.discussLink': 'GitHubで相談 →',
    ...
    'section.support.eyebrow': 'つくり続けるために',
    'section.support.title1': '任意のサポート。',
    'section.support.title2': 'カタログと同じ誠実さで。',
    'section.support.desc':
      'Banalの利用は無料です——ペイウォール、アカウント、広告はありません。構築と保守には、自己負担のスタックから相当の時間と推論トークンがかかります。',
    'section.support.contributeTitle': 'コードで貢献する',
    'section.support.contributeDesc':
      '個人アカウントの公開リポジトリです。コラボレーター招待は不要です。リンク切れや提案は<a href="https://github.com/sakurablush/banal/issues" target="_blank" rel="noopener noreferrer" class="text-violet-400 hover:text-violet-300 underline">Issues</a>または<a href="https://github.com/sakurablush/banal/discussions" target="_blank" rel="noopener noreferrer" class="text-violet-400 hover:text-violet-300 underline">Discussions</a>へ。コード変更はフォークしてPRを出してください。内容を確認してマージします。',
    'section.support.tipTitle': '資金的に支える',
    'section.support.tipDesc':
      'Banalが時間やコストの節約になったと感じ、次の調査や推論代（初版の制作も保守も）の一部を支えたい場合だけ。特典も段階も義務もありません。',
    'section.support.bitcoin': 'ビットコイン',
    'section.support.ethereum': 'イーサリアム',
    'section.support.litecoin': 'ライトコイン',
    'section.support.dogecoin': 'ドージコイン',
    'section.support.copy': 'コピー',
    'section.support.copied': 'コピー済み',
...
export function applyTranslations(
  ...
  // Update all marked text elements (safe HTML only for strings that include markup)
  scope.querySelectorAll<HTMLElement>('[data-i18n]').forEach((el) => {
    const key = el.getAttribute('data-i18n');
    if (!key) return;
    const translated = t(lang, key);
    applyTranslationContent(el, translated);
  });
