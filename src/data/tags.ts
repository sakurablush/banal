...
export const ACCESS_TAGS: TagDefinition[] = [
  ...
  },
  {
    ...
    label: 'Free Signup',
    category: 'access',
    description: 'Account required but free',
    icon: '\u{1F511}',
  },
  {
    id: 'no-api-key',
  ...
  },
  {
    ...
    label: 'Cloud Hosted',
    category: 'access',
    description: 'Hosted by provider',
    icon: '\u{2601}\uFE0F',
  },
];
...
export const PRICING_TAGS: TagDefinition[] = [
  ...
  },
  {
    ...
    label: 'Free Tokens',
    category: 'pricing',
    description: 'Free API tokens or credits',
    icon: '\u{1FA99}',
  },
  {
    id: 'freemium',
  ...
  },
  {
    ...
    label: 'Rate Limited',
    category: 'pricing',
    description: 'Usage limits apply',
    icon: '\u{26A1}',
  },
  {
    id: 'daily-limit',
...
export const PLATFORM_TAGS: TagDefinition[] = [
  {
    ...
    label: 'Browser',
    category: 'platform',
    description: 'Runs in web browser',
    icon: '\u{1F310}',
  },
  {
    id: 'desktop-windows',
...
export const CAPABILITY_TAGS: TagDefinition[] = [
  ...
  },
  {
    ...
    label: 'Cloud Models',
    category: 'capability',
    description: 'Use cloud-hosted models',
    icon: '\u{2601}\uFE0F',
  },
  {
    id: 'multi-model',
    label: 'Multi-Model',
    category: 'capability',
    description: 'Supports multiple models',
    icon: '\u{1F500}',
  },
  {
    id: 'gpu-required',
  ...
  },
  {
    ...
    label: 'Low Hardware',
    category: 'capability',
    description: 'Works on low-end machines',
    icon: '\u{1F4C9}',
  },
  {
    id: 'high-context',
    label: '1M+ Context',
    category: 'capability',
    description: 'Supports 1M+ token context',
    icon: '\u{1F4DC}',
  },
  {
    id: 'vision',
  ...
  // Dev-specific
  {
    ...
    category: 'capability',
    description: 'Integrates with Git',
    icon: '\u{1F500}',
  },
  {
    id: 'ci-cd',
...
export const QUALITY_TAGS: TagDefinition[] = [
  {
    ...
    label: 'Verified',
    category: 'quality',
    description: 'Verified by Banal team',
    icon: '\u{2705}',
  },
  {
    id: 'privacy-friendly',
    ...
    category: 'quality',
    description: 'Strong privacy practices',
    icon: '\u{1F512}',
  },
  {
    id: 'no-telemetry',
  ...
  },
  {
    ...
    category: 'quality',
    description: 'Suitable for enterprise',
    icon: '\u{1F3E2}',
  },
  {
  ...
  },
  {
    ...
    label: 'Freelancer Friendly',
    category: 'quality',
    description: 'Good for freelancers',
    icon: '\u{1F4BC}',
  },
  {
    id: 'indie-hacker',
    label: 'Ship your own app',
    category: 'quality',
    description: 'Good for solo app builders',
    icon: '\u{1F4BB}',
  },
];
...
export function getNonContradictingTags(
  available: TagDefinition[],
  activeTags: string[]
): TagDefinition[] {
