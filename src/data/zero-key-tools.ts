...
export const zeroKeyTools: ZeroKeyTool[] = [
  {
    ...
    qualityNote: "DuckDuckGo puts strong hosted models behind a privacy-first chat surface with no account friction.",
  ...
  },
  {
    ...
    qualityNote: "The Arena ecosystem is one of the best public ways to test many capable models against the same prompt.",
  },
  {
    id: "webllm-chat",
    name: "WebLLM Chat",
    ...
    qualityNote: "Runs open models in the browser through WebGPU. This is the strongest privacy story in the web section.",
  ...
  },
  {
    ...
    qualityNote: "Practical browser chat with very low friction; useful as the emergency fallback tab.",
  },
  {
    ...
    qualityNote: "The deepest community lab on the web; excellent if you search by model or task, not random hype.",
  ...
  },
  {
    ...
    qualityNote: "The most popular AI chatbot. Free tier gives access to GPT-4o-mini and limited GPT-4o, which handles most everyday tasks well.",
    caveat: "Free tier has usage caps that reset periodically. Some features require Plus subscription.",
  },
  {
    ...
    qualityNote: "One of the best free options because it often runs GPT-4 class models without requiring login. Includes image generation via DALL-E.",
  ...
  },
  {
    ...
    bestFor: "Multimodal AI chat with image understanding, Google ecosystem integration, and long context.",
    qualityNote: "Free access to Gemini models with strong reasoning. Excellent for tasks involving images, long documents, and Google Workspace.",
  ...
  },
  {
    ...
    qualityNote: "Powered by Llama models. Offers surprisingly capable chat and image generation with zero friction.",
  ...
  },
  {
    ...
    qualityNote: "Designed specifically for natural conversation. More empathetic and patient than most chatbots, great for brainstorming.",
  ...
  },
  {
    ...
    qualityNote: "Free tier available via X. Strong at current events and trending topics due to real-time data access.",
  ...
  },
  {
    ...
    qualityNote: "Unique hybrid of search engine and AI chat. Free tier lets you switch between different AI models for answers.",
  ...
  },
  {
    ...
    qualityNote: "Custom LPU hardware makes it the fastest way to run Llama, Mixtral, and other open models. Free tier is generous.",
  ...
  },
  {
    ...
    qualityNote: "The best free AI search tool for serious research. Every answer includes clickable source citations.",
  ...
  },
  {
    ...
    qualityNote: "DeepSeek-V3 and R1 models punch well above their weight. Excellent for math, coding, and analytical tasks at zero cost.",
  ...
  },
  {
    ...
    qualityNote: "Built specifically for developers. Searches technical content and generates code-aware answers with sources.",
  ...
  },
  {
    ...
    bestFor: "Free access to Mistral models including the powerful Mistral Large for complex tasks.",
    qualityNote: "European AI lab with strong models. Free tier includes access to their full model lineup including canvas and code features.",
  ...
  },
  {
    ...
    qualityNote: "Run by Hugging Face, the open-source AI hub. Gives free access to top open models like Llama, Mixtral, and Command R+.",
  ...
  },
  {
    ...
    qualityNote: "By Quora. Free tier gives access to GPT-4o-mini, Claude, Gemini, and thousands of custom bots in one place.",
  ...
  },
  {
    ...
    qualityNote: "One of the rare truly unlimited, no-login image generators. Quality is decent for concepts and illustrations.",
  ...
  },
  {
    ...
    qualityNote: "Formerly DALL-E Mini. Simple interface, generates multiple images per prompt. Good for rapid ideation.",
  ...
  },
  {
    ...
    qualityNote: "Offers text-to-image, style transfer, and other visual AI tools without requiring an account.",
  ...
  },
  {
    ...
    qualityNote: "Unique in offering both a web UI and a completely open API. Perfect for developers building image features into free apps.",
  },
  {
    ...
    qualityNote: "A delightful tool that takes your doodles and a text prompt to create refined images. Great for visual ideation.",
  },
  {
    id: "remove-bg",
    name: "Remove.bg",
    ...
    qualityNote: "The gold standard for background removal. Results are immediate and remarkably accurate.",
  ...
  },
  {
    ...
    qualityNote: "Brush over anything you want removed and AI fills it in naturally. Surprisingly good results for free.",
  ...
  },
  {
    ...
    bestFor: "Creating professional designs, social media graphics, and presentations without design skills.",
    qualityNote: "The most accessible design tool for non-designers. Free tier includes AI image generation, templates, and a huge asset library.",
  ...
  },
  {
    ...
    qualityNote: "Combines DALL-E image generation with design templates. Generous free tier for social media graphics and visual content.",
  ...
  },
  {
    ...
    qualityNote: "Offers 150 daily free tokens, multiple specialized models, and features like image-to-image. Quality rivals paid tools.",
  ...
  },
  {
    ...
    bestFor: "AI images that actually render text correctly — logos, posters, signs, and typography.",
    qualityNote: "The best free tool for images containing readable text. Other generators struggle with text; Ideogram excels at it.",
  ...
  },
  {
    ...
    bestFor: "Full-featured video editing with AI-powered captions, effects, and background removal.",
    qualityNote: "By ByteDance. The best free video editor for short-form content. AI auto-captions alone save hours of work.",
  ...
  },
  {
    ...
    qualityNote: "Acquired by Microsoft, now built into Windows. Free tier includes AI text-to-speech, templates, and stock media.",
  ...
  },
  {
    ...
    qualityNote: "Aggregates several AI generation models. Useful for comparing outputs and finding what works for your use case.",
  ...
  },
  {
    ...
    qualityNote: "Google Flow Music (formerly Riffusion). Uses spectrograms from text prompts for background music and jingles.",
  ...
  },
  {
    ...
    bestFor: "Converting text to natural-sounding speech in multiple languages without registration.",
    qualityNote: "Simple and effective TTS with a wide selection of voices and languages. No account needed for basic use.",
  ...
  },
  {
    ...
    qualityNote: "Offers AI voice conversion, text-to-music, and stem splitting. Fun for creators exploring AI music.",
  ...
  },
  {
    ...
    bestFor: "Generating complete songs with vocals, lyrics, and instrumentation from text prompts.",
    qualityNote: "The most impressive free AI music tool. Generates full songs with realistic vocals that sound surprisingly professional.",
  ...
  },
  {
    ...
    bestFor: "A Swiss Army knife of free AI and file tools: writing, PDF, image, video, all in one.",
    qualityNote: "Hundreds of free tools including AI writer, summarizer, PDF converter, image editor. Files auto-delete for privacy.",
  ...
  },
  {
    ...
    qualityNote: "Collection of free AI writing tools including text generator, paraphraser, and content detector.",
  },
  {
    id: "quillbot",
    name: "QuillBot",
    ...
    bestFor: "Paraphrasing, grammar checking, and summarizing text for academic and professional writing.",
    qualityNote: "The best free paraphrasing tool. Also includes grammar checker, summarizer, and citation generator.",
  ...
  },
  {
    ...
    qualityNote: "Consistently outperforms Google Translate for nuanced text. No account needed for web use. Supports documents too.",
    caveat: "Free web version has character limits per translation. Some language pairs better than others.",
  },
  {
    id: "google-translate",
    ...
    qualityNote: "The widest language coverage of any free translator. Includes camera translation, conversation mode, and offline support.",
  ...
  },
  {
    ...
    qualityNote: "Open-source grammar checker that works across languages. Great Grammarly alternative, especially for non-English writing.",
  ...
  },
  {
    ...
    bestFor: "Making your writing clear and concise by highlighting complex sentences and passive voice.",
    qualityNote: "Unique tool that focuses purely on readability. Highlights hard-to-read sentences, adverbs, and passive voice.",
  ...
  },
  {
    ...
    qualityNote: "Excellent for marketing-specific writing. Templates for ads, emails, product descriptions, and social media.",
  ...
  },
  {
    ...
    qualityNote: "Good for structured content creation with tone and use-case templates. Outputs are decent starting points.",
  ...
  },
  {
    ...
    qualityNote: "Upload any PDF and chat with it. Excellent for quickly understanding research papers, contracts, and long documents.",
  ...
  },
  {
    ...
    qualityNote: "Part of the trusted Smallpdf suite. AI summarization is accurate and highlights the most important sections.",
  ...
  },
  {
    ...
    qualityNote: "The most comprehensive free PDF toolkit on the web. Handles conversions, compression, and editing without an account.",
  ...
  },
  {
    ...
    qualityNote: "Completely free, no file limits, and genuinely no-login. One of the most generous free PDF toolkits available.",
  },
  {
    ...
    qualityNote: "The most trustworthy AI search tool because it shows its sources. Excellent for research, fact-checking, and learning.",
  ...
  },
  {
    ...
    qualityNote: "Searches across 200M+ academic papers and synthesizes findings. Essential for evidence-based decision making.",
    caveat: "Free tier limits searches per month. Best for scientific/medical/social science questions.",
  },
  {
    id: "elicit",
    name: "Elicit",
    ...
    bestFor: "Automating literature review by finding, summarizing, and extracting data from papers.",
    qualityNote: "Built specifically for researchers. Extracts structured data from papers and helps synthesize findings across studies.",
  ...
  },
  {
    ...
    bestFor: "Finding and understanding academic papers with AI-generated summaries and citation graphs.",
    qualityNote: "By Allen AI. Covers 200M+ papers with AI-generated TLDRs, citation context, and influence scores. Completely free.",
  },
  {
    id: "connected-papers",
    ...
    qualityNote: "Creates beautiful visual graphs of paper relationships. Invaluable for literature reviews and finding seminal works.",
  ...
  },
  {
    ...
    qualityNote: "The computational knowledge engine. Solves equations, plots functions, converts units, and answers factual queries with precision.",
  ...
  },
  {
    ...
    bestFor: "Interactive graphing calculator for visualizing functions, data, and geometric constructions.",
    qualityNote: "The best free graphing calculator on the web. Used by millions of students and teachers. Beautifully designed.",
  },
  {
    id: "geogebra",
    name: "GeoGebra",
    ...
    bestFor: "Interactive geometry, algebra, calculus, and statistics tools for learning and teaching.",
    qualityNote: "Comprehensive free math software used worldwide in education. Includes graphing, geometry, 3D, spreadsheets, and CAS.",
  },
  {
    id: "khan-academy",
    name: "Khan Academy",
    ...
    qualityNote: "Completely free education platform with Khanmigo AI tutor. Covers K-12 through college-level courses with practice exercises.",
  ...
  },
  {
    ...
    qualityNote: "Shows detailed solution steps, not just answers. Covers a wide range of math topics from basic to advanced.",
  ...
  },
  {
    ...
    qualityNote: "Solves problems across basic math, algebra, calculus, statistics, and more. Camera input makes it great for homework.",
  ...
  },
  {
    ...
    bestFor: "Creating beautiful presentations, documents, and websites from a text prompt in minutes.",
    qualityNote: "The best AI presentation tool. Generates polished, professional slides from a simple description. Results look genuinely good.",
  ...
  },
  {
    ...
    bestFor: "Presentations that automatically follow design rules so they always look professional.",
    qualityNote: "Smart templates that adapt as you add content. The AI enforces good design principles automatically.",
  ...
  },
  {
    ...
    qualityNote: "Works as a Google Slides add-on. Paste your text and it generates a complete slide deck with layouts and images.",
  ...
  },
  {
    ...
    qualityNote: "A rare tool that is both web-friendly and API-friendly, with open access patterns developers can wire up fast.",
  },
  {
    id: "excalidraw",
    name: "Excalidraw",
    ...
    bestFor: "Explaining ideas, system diagrams, UI sketches, and plans without a design subscription.",
  ...
  },
  {
    ...
    qualityNote: "One of the strongest free browser image editors, especially for PSD and practical design work.",
  },
  {
    id: "penpot",
    name: "Penpot",
  ...
  },
  {
    ...
    qualityNote: "A boring, dependable classic. It saves locally and does not force an account for core work.",
  },
  {
    id: "stackblitz",
    name: "StackBlitz",
    ...
    qualityNote: "Fast browser development environment that removes install friction for learners and broke machines.",
  },
  {
    id: "codesandbox",
    name: "CodeSandbox",
    ...
    qualityNote: "Still one of the easiest ways to make code visible and shareable from any browser.",
  },
  {
    id: "bolt-new",
    name: "Bolt.new",
    ...
    bestFor: "Building and deploying full-stack web apps entirely in the browser with AI assistance.",
    qualityNote: "By StackBlitz. Describe what you want in natural language and it generates, runs, and deploys a full-stack app. Revolutionary for prototyping.",
  ...
  },
  {
    ...
    bestFor: "Generating production-ready React/Next.js UI components from text descriptions or images.",
    qualityNote: "The best AI tool for generating React components with Tailwind CSS. Outputs clean, copy-pasteable code that actually works.",
  ...
  },
  {
    ...
    qualityNote: "Full development environment in the browser. AI agent can build apps from descriptions. Great for learning and prototyping.",
  ...
  },
  {
    ...
    bestFor: "Adding AI code assistance to VS Code or JetBrains with any model, including local ones.",
    qualityNote: "The leading open-source AI coding assistant. Works with Ollama, OpenAI, Anthropic, or any provider. Full data control.",
  },
  {
    id: "ollama",
    name: "Ollama",
    ...
    qualityNote: "The easiest way to run Llama, Mistral, CodeLlama, and dozens of open models locally. One command to get started.",
  ...
  },
  {
    ...
    qualityNote: "Free tier includes generous autocomplete and chat. Codebase-aware context means better answers than generic AI.",
  ...
  },
  {
    ...
    qualityNote: "Generous free tier and production-grade delivery for small teams and solo builders.",
  },
  {
    id: "supabase",
    name: "Supabase",
    ...
    qualityNote: "The quickest credible open-source Firebase alternative for developers on a zero-dollar start.",
  ...
  },
  {
    ...
    qualityNote: "A practical free database path with developer-friendly branching and modern Postgres ergonomics.",
  },
  {
    id: "railway",
    name: "Railway",
  ...
  },
  {
    ...
    qualityNote: "Powerful workflow automation with a self-hostable path that can replace a lot of paid glue.",
  ...
  },
  {
    ...
    qualityNote: "One of the best free self-hosted uptime monitors: polished, practical, and widely used.",
  },
  {
    id: "kuma-status",
    name: "OpenStatus",
    ...
    qualityNote: "A credible open-source alternative in a category that often becomes expensive fast.",
  },
  {
    id: "vaultwarden",
    name: "Vaultwarden",
    ...
    bestFor: "Running a lightweight Bitwarden-compatible password manager for a family or small group.",
    qualityNote: "A proven, resource-light way to get excellent password management without a subscription.",
  ...
  },
  {
    ...
    bestFor: "Private file storage for documents that should not sit unprotected on a shared machine.",
  ...
  },
  {
    ...
    qualityNote: "Excellent open-source notes app with local-first control and multiple sync options.",
  },
  {
    id: "cryptpad",
    name: "CryptPad",
    ...
    qualityNote: "End-to-end encrypted collaboration is rare in free web tools; CryptPad is a serious option.",
  },
  {
    id: "libretranslate",
    name: "LibreTranslate",
  ...
  },
  {
    ...
    qualityNote: "Massive, proven free curriculum with real practice instead of passive videos only.",
  },
  {
    id: "roadmap-sh",
    name: "roadmap.sh",
  ...
  },
  {
    ...
    qualityNote: "No API key, clear docs, strong model coverage, and a self-hostable open-source server.",
  ...
  },
  {
    ...
    qualityNote: "Official US weather data is the right source for serious alerting and civic tools.",
  ...
  },
  {
    ...
    bestFor: "Finding US federal datasets across health, labor, climate, finance, and public services.",
  ...
  },
  {
    ...
    qualityNote: "A reliable starter API for real apps and teaching because the domain is useful and understandable.",
  },
  {
    id: "frankfurter",
    name: "Frankfurter",
  ...
  },
  {
    ...
    qualityNote: "Community-maintained open food database with real-world utility for low-budget apps.",
  },
  {
    id: "overpass-api",
    name: "Overpass API",
    ...
    qualityNote: "OpenStreetMap queries can power practical local-help tools without proprietary maps.",
  ...
  },
  {
    ...
    qualityNote: "Direct access to one of the most valuable public knowledge infrastructures on earth.",
  },
  {
    id: "open-library-api",
  ...
  },
  {
    ...
    bestFor: "Open DevOps automation around GitLab projects, pipelines, issues, and merge requests.",
    qualityNote: "Broad API surface that can power serious internal tools even on free/self-hosted GitLab.",
  },
  {
    id: "jsonplaceholder",
  ...
  },
  {
    ...
    qualityNote: "More practical fake data than toy examples, with endpoints that resemble real app work.",
  },
  {
    id: "httpbin",
    name: "httpbin",
  ...
  },
  {
    ...
    qualityNote: "Useful because the API is simple enough for beginners and open enough for rapid prototypes.",
  },
  {
    ...
    qualityNote: "The self-host path matters: translation can be a privacy-sensitive survival tool.",
  ...
  },
  {
    ...
    qualityNote: "Practical infrastructure glue for Docker, Kubernetes, CI, and config-heavy repos.",
  },
  {
    id: "httpie",
    name: "HTTPie CLI",
  ...
  },
  {
    ...
    qualityNote: "The universal network tool. It is everywhere, documented everywhere, and still unbeatable.",
  },
  {
    id: "git",
    name: "Git",
  ...
  },
  {
    ...
    qualityNote: "Excellent for people who know Git concepts but need a clearer interface under pressure.",
  },
  {
    id: "hyperfine",
    name: "hyperfine",
  ...
  },
  {
    ...
    qualityNote: "Production-grade browser automation for free, with great docs and cross-browser support.",
  },
  {
    id: "just",
    name: "just",
    ...
    qualityNote: "Small, readable automation that helps contributors succeed without tribal knowledge.",
  },
  {
    id: "direnv",
    name: "direnv",
  ...
  },
  {
    ...
    qualityNote: "Rootless containers and open tooling make it a strong choice for low-budget dev environments.",
  },
  {
    id: "sqlite",
    name: "SQLite",
  ...
  },
  {
    ...
    qualityNote: "A must-have for anyone using free credits or API keys they cannot afford to leak.",
  },
  {
    id: "age",
    name: "age",
  ...
  },
  {
    ...
    qualityNote: "The broadest open-model catalog on a hosted API. Free inference is useful for experiments, demos, and low-volume prototypes.",
    caveat: "Free endpoints share capacity and can sleep or rate-limit; production workloads need paid endpoints or self-hosting.",
  ...
  },
  {
    ...
    bestFor: "Starting with Kilo Code and Kilo Gateway, then choosing free, BYOK, or paid model routing.",
    qualityNote: "Kilo AI is the product hub for Kilo Code and Kilo Gateway; it documents Auto Free routes and no-credit usage paths.",
    caveat: "Free model routes are rate-limited and may log prompts/outputs depending on the upstream provider; avoid sensitive data.",
    lastVerified: "2026-06-12",
  },
  {
    id: "kilo-gateway",
    ...
    bestFor: "Routing app and agent requests through 500+ models with free routes, BYOK, or local inference.",
    qualityNote: "Kilo Gateway centralizes inference across many providers and exposes free model routes such as kilo-auto/free.",
    caveat: "Anonymous free routes are rate-limited; some free providers may log data, so use caution with confidential code.",
    lastVerified: "2026-06-12",
  },
  {
    id: "openrouter-free",
    ...
    qualityNote: "OpenRouter keeps a curated free-model catalog and an openrouter/free router for experiments, coding, and chat.",
    caveat: "Free variants are capped per minute/day and the roster rotates; check each model page before relying on it.",
    lastVerified: "2026-06-12",
  },
  {
    id: "groq-api",
    ...
    qualityNote: "Groq publishes concrete free limits by model and is one of the fastest hosted paths for open-weight inference.",
    caveat: "Free limits are low enough for prototypes but not high-volume production; quotas vary by model and organization.",
    lastVerified: "2026-06-12",
  },
  {
    id: "free-the-ai",
    ...
    bestFor: "A free OpenAI-compatible API gateway for chat, tools, streaming, and image endpoints.",
    qualityNote: "FreeTheAi aggregates many models behind one key with no credit card or billing setup, useful for hobby apps.",
    caveat: "Requires Discord/key signup and has daily success caps; availability and model quality can change quickly.",
    lastVerified: "2026-06-12",
  },
  {
    id: "glhf-gg",
  ...
  },
  {
    ...
    qualityNote: "Cerebras publishes a free tier around 1M tokens/day and 14,400 requests/day for selected models, with OpenAI-compatible API access.",
    caveat: "Requires account. Free tier context and model selection are limited; verify current quotas before production use.",
    lastVerified: "2026-06-12",
  },
  {
    id: "fal-ai",
  ...
  },
  {
    ...
    qualityNote: "Google-backed workspace with free Gemini API quotas; Flash models can use very large context and token-per-minute allowances.",
    caveat: "Requires Google account. Free-tier prompts may be used to improve Google services; check data controls before sensitive work.",
    lastVerified: "2026-06-12",
  },
  {
    ...
    qualityNote: "Google AI Studio/Gemini API exposes free-tier Gemini models with large context windows and strong multimodal support.",
    caveat: "Requires Google account/project. Free usage may be used to improve Google services and rate limits vary by model.",
    lastVerified: "2026-06-12",
  },
  {
    id: "claude-free",
  ...
  },
  {
    ...
    bestFor: "VS Code, JetBrains, and CLI coding agent with open-source workflow and free model routing.",
    qualityNote: "Apache-2.0 coding agent that can use Kilo Gateway free models, BYOK, local models, or paid providers with zero markup.",
  ...
  },
  {
    ...
    bestFor: "General-purpose, multilingual, coding, reasoning. The most popular open model family.",
    qualityNote: "Apache 2.0 license. Use via Ollama, LM Studio, or HuggingFace. 8B for laptops, 70B for desktops, 405B for servers.",
  ...
  },
  {
    ...
    qualityNote: "Apache 2.0. Best-in-class for multilingual tasks and code. 0.6B runs on phones, 72B on workstations, 397B on servers.",
  ...
  },
  {
    ...
    qualityNote: "MIT license. R1 is reasoning-focused, V3 is general-purpose. Both excellent for technical tasks. Quantized versions run on consumer hardware.",
  ...
  },
  {
    ...
    qualityNote: "Apache 2.0. Mistral AI (France). Small 3 (22B) is efficient for most tasks. Medium 3 for better quality. Mixtral 8x22B for high capability.",
  ...
  },
  {
    ...
    qualityNote: "Apache 2.0 (check exact terms for latest). Gemma 3 is designed for efficiency. 2B-27B range. Good for devices with limited RAM.",
