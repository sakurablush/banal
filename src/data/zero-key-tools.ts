...
export const zeroKeyTools: ZeroKeyTool[] = [
  ...
  },
  {
    ...
    bestFor:
      'Trying many different AI models (GPT-4, Claude, Gemini) and community bots from one interface.',
    qualityNote:
  ...
  },
  {
    ...
    bestFor:
      'All-in-one workspace for notes, wikis, and project management with basic AI features.',
    qualityNote:
      'Free for personal use with generous limits. Free tier includes basic AI writing assistant; full AI requires paid add-on.',
  ...
  },
  {
    ...
    caveat:
      'Free tier limited to 50 slow requests/month. Pro plan $20/mo for unlimited fast requests.',
  ...
  },
  {
    ...
    qualityNote: 'Apache-2.0, browser-based. No installation required. Good for quick prototyping.',
  ...
  },
  {
    ...
    qualityNote:
      'MIT license. Released June 2026. 753B MoE with IndexShare sparse attention (2.9x FLOPs reduction at 1M ctx). SWE-bench Pro 62.1, DeepSWE 46.2, Terminal-Bench 2.1 81.0.',
