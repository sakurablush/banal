...
export const zeroKeyTools: ZeroKeyTool[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // ADDITIONAL TOOLS (batch 4 — expanding to 200+)
  // ──────────────────────────────────────────────────────────────────────────
  ...
  // AI PRESENTATIONS
  {
    ...
    access: 'free-tier',
    badges: ['AI slides', 'beautiful', 'fast'],
    bestFor: 'Creating beautiful presentations from text prompts instantly.',
    qualityNote: 'Best-in-class AI presentation generator with modern designs.',
    caveat: 'Free tier has limited credits; watermark on exports.',
  },
  ...
  // AI AUDIO & MUSIC
  {
    ...
    category: 'ai-audio',
    access: 'free-tier',
    badges: ['music generation', 'AI songs', 'lyrics'],
    bestFor: 'Creating complete songs with vocals from text prompts.',
    qualityNote: 'Best free AI music generator with surprisingly good results.',
    caveat: 'Free tier has daily generation limits.',
  },
  {
    id: 'udio',
    name: 'Udio',
  ...
  // AI VIDEO
  {
    ...
    category: 'ai-video',
    access: 'free-tier',
    badges: ['text-to-video', 'creative', 'fast'],
    bestFor: 'Creating short videos from text prompts or images.',
    qualityNote: 'One of the best free text-to-video generators.',
    caveat: 'Free tier has daily generation limits.',
  },
  {
    id: 'haiper',
  ...
  // AI IMAGE
  {
    ...
    category: 'ai-image',
    access: 'free-tier',
    badges: ['art', 'quality', 'web'],
    bestFor: 'Creating stunning AI art with industry-leading quality.',
    qualityNote: 'Top-tier image generation; web beta is more accessible.',
    caveat: 'Limited free trial; subscription for continued use.',
  },
  {
    id: 'tensor-art',
    name: 'Tensor.Art',
  ...
  },
  {
    ...
    category: 'dev-coding',
    access: 'free-tier',
    badges: ['AI autocomplete', 'IDE extension', 'free'],
  ...
  },
  {
    ...
    category: 'ai-coding',
    access: 'no-login',
    badges: ['VS Code', 'JetBrains', '36 providers', 'zero config'],
