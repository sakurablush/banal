...
// Latest 2026 models - ai-models category
   ...
   },
   {
     ...
     bestFor: 'Agentic coding with top SWE-bench Pro score (58.4%). 8-hour autonomous task execution.',
     qualityNote:
   ...
   },
   {
     ...
     bestFor: 'Coding-first with 1M token context window. Long-horizon autonomous software development.',
     qualityNote:
   ...
   },
   {
     ...
     bestFor: 'Massive multilingual model with 22B active parameters across 235B MoE. Think/Non-think modes.',
     qualityNote:
   ...
   },
   {
     ...
     bestFor: 'Specialized coding model with 480B total / 35B active. Agentic coding with 61.8% on Aider Polyglot.',
     qualityNote:
