...
export function renderOnboarding(container: HTMLElement, lang: Lang): void {
...
function renderStep1(container: HTMLElement, state: OnboardingState, copy: typeof COPY.en): void {
...
function renderStep2(container: HTMLElement, state: OnboardingState, copy: typeof COPY.en): void {
  const title = create('h3', 'step-title');
...
function renderStep3(container: HTMLElement, state: OnboardingState, copy: typeof COPY.en): void {
  const title = create('h3', 'step-title');
...
function renderStep4(container: HTMLElement, state: OnboardingState, copy: typeof COPY.en): void {
  const title = create('h3', 'step-title');
...
function renderResults(container: HTMLElement, state: OnboardingState, copy: typeof COPY.en): void {
...
function findMatchingStacks(answers: OnboardingAnswers): ToolStack[] {
  ...
  const minScore = 1;
  return scored.filter((s) => s.totalCriteria === 0 || s.score >= minScore).map((s) => s.stack);
}
