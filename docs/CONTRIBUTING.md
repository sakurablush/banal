...
- The commit message and PR description are clear about _why_ this
...
the _quality of the result for the end user_, not on how polished the
PR looks.
...
- Commit often with messages that say what changed and _why_ for the
